...
# read the csv file
Z1 = pd.read_csv("kCError 5.0 cm (log scale).csv") # read the csv file
...
for ridx in range(nrow):
    for cidx in range(ncol):
        ...
        ef1 = ax[0,0].imshow(Z_dens, aspect='auto', extent=[min_C,max_C,max_k,0.1], 
                            cmap='Blues9', norm=norm1, interpolation = "spline16") # Error field  interpolation = "spline16" 
